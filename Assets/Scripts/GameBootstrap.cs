    ...
    public class GameBootstrap : MonoBehaviour
    {
        void Start()
        {
            ...
            objectives.quests = new List<Quest>
            {
                ...
                new Quest { age = 0, title = "Build a Wood Hut, then a Woodpile to store its Wood", done = () => HasCollectorOf(wood) && HasStorageOf(wood), reward = () => carriedInv.Add(wood, 15), rewardText = "+15 Wood", highlightBuilding = woodHut },
                ...
                new Quest { age = 0, title = "Now the Stone chain: a Stone Pit → Belt → Stone Stockpile", done = () => HasCollectorOf(stone) && HasStorageOf(stone) && Belt.Count >= 2, reward = () => carriedInv.Add(stone, 15), rewardText = "+15 Stone", highlightBuilding = stonePit },
                ...
                new Quest { age = 0, title = "Build an Idea Bench + Research Lodge (side by side)", done = () => HasWorkshopOf(ideaTablet) && ResearchBuilding.All.Count > 0, reward = () => carriedInv.Add(stone, 12), rewardText = "+12 Stone", highlightBuilding = ideaBench },
                ...
                new Quest { age = 1, title = "Fire 15 Bricks: build a Clay Pit + a Kiln (Clay + Charcoal)", done = () => Have(bricks) >= 15, progress = () => (Have(bricks), 15), reward = () => carriedInv.Add(clay, 20), rewardText = "+20 Clay", highlightBuilding = kiln },
